...
%% preamble
\title[EOSBIXIN]{Distributed Nash Equilibrium Seeking On a Consensus based Gaming}
% \subtitle{The subtitle}
\author[Ryan J. Kung]{\includegraphics[height=2cm]{./ieee-blockchain.png} \\ Ryan J. Kung}
...
\begin{frame}
  \frametitle{Definition}
    ...
    We defined DGaming as a series of Gaming Behaviors and Strategis which is Distributed. With Lamport's defination on 1978, A Gaming is Distributed if the message transaction delay is not negligible compared to the time between event in classic gaming behavior.
\end{frame}

\begin{frame}
  \frametitle{Lamport TimeStamp}
  \begin{figure}[H]
    \centering
